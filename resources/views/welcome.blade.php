...
<head>
    ...
    <meta name="twitter:creator" content="@nnsdev" />
    <meta property="og:url" content="https:/spotify.malding.dev" />
...
<body class="bg-green-800 text-white h-screen font-sans">
    <div id="app">
        ...
        <div class="flex items-center h-screen w-full">
            <div class="w-full mx-auto text-center">
                ...
                <a href="/login" class="p-2 rounded-xl border-2 border-white bg-transparent text-white no-underline hover:bg-white hover:text-green-800 hover:border-transparent">Check your Statistics</a>
            </div>
        </div>
    </div>
